...
if __name__ == "__main__":
    ...
    if clientID!=-1:
        ...
        res, prox_sensor_f = getObjectHandle('Proximity_sensor0')
        res, prox_sensor_r = getObjectHandle('Proximity_sensor1')
        res, prox_sensor_b = getObjectHandle('Proximity_sensor2')
        ...
        while True:
            ...
            returnCode, detectionState = sim.simxReadProximitySensor(clientID, prox_sensor_f, sim.simx_opmode_streaming)[0:2] #simx_opmode_streaming
            returnCode, detectSide = sim.simxReadProximitySensor(clientID, prox_sensor_r, sim.simx_opmode_streaming)[0:2] #simx_opmode_streaming
            returnCode, detectBack = sim.simxReadProximitySensor(clientID, prox_sensor_b, sim.simx_opmode_streaming)[0:2] #simx_opmode_streaming
